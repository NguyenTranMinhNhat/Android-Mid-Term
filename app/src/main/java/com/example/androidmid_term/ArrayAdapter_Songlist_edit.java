...
public class ArrayAdapter_Songlist_edit extends ArrayAdapter<Song> {
    Context context;
    int resource;
    ArrayList<Song> data ;
    ...
    public ArrayAdapter_Songlist_edit(@NonNull Context context, int resource, ArrayList data) {
